        ...
        <div className="mx-auto mt-10 grid max-w-[1100px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_12px_30px_rgba(15,23,42,0.06)] lg:grid-cols-[0.9fr_1.2fr]">
          <div className="flex flex-col justify-center p-6 sm:p-8">
            ...
            <a
              ...
              className="mt-6 inline-flex h-11 w-fit items-center justify-center rounded-full bg-brand-navy px-6 text-sm font-semibold text-white transition hover:bg-[#0f3a63]"
            >
              Open in Google Maps
            </a>
          </div>
