...
export function ProjectCard({
  ...
  if (onClick) {
    return (
      <button
        type="button"
        onClick={onClick}
        className="group block h-full w-full rounded-2xl text-left transition hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-green focus-visible:ring-offset-4"
      >
        {content}
      </button>
    );
  ...
  return <article className="group h-full rounded-2xl transition hover:-translate-y-1">{content}</article>;
}
