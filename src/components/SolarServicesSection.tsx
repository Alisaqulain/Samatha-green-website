...
const services = [
  ...
  },
  {
    ...
    image: "/service-hybrid-generator.jpg",
    imageRight: false,
    points: [
...
export default function SolarServicesSection() {
  return (
    <section className="bg-white px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div className="mx-auto mt-12 flex max-w-[1200px] flex-col gap-10">
